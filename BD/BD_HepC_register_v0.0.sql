...
SELECT
	...
	CASE WHEN ti.treatment_end_date IS NOT NULL THEN ti.treatment_end_date WHEN ti.treatment_end_date IS NULL AND ti.medication_duration = '12 weeks' THEN (ti.treatment_start_date + INTERVAL '12 weeks')::date WHEN ti.treatment_end_date IS NULL AND ti.medication_duration = '24 weeks' THEN (ti.treatment_start_date + INTERVAL '24 weeks')::date END AS treatment_end_date_initial,
